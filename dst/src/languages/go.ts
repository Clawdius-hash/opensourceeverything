...
const MEMBER_CALLS: Record<string, CalleePattern> = {
  ...
  'http.ServeFile':         { nodeType: 'EGRESS', subtype: 'http_response', tainted: false },
  ...
  'md5.New':                { nodeType: 'TRANSFORM', subtype: 'encrypt',     tainted: false },
  'md5.Sum':                { nodeType: 'TRANSFORM', subtype: 'encrypt',     tainted: false },
